...
/////// Diffuse:
                ...
                float node_7808 = saturate((_CliffMult*(1.0 - dot(float3(0,1,0),i.normalDir))));
                float node_5810 = (1.0 - node_7808);
                float3 diffuseColor = ((_SandColor.rgb*(1.0 - node_219))+(node_219*((_SnowColor.rgb*snow)+((1.0 - snow)*((_ClifColor.rgb*node_7808)+(node_5810*_BaseColor.rgb))))));
